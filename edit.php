...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-4 mb-4">
      <div class="card">
        <h2 class="card-header">Edit Information</h2>
        <div class="card-body">
    
          <form name="myForm" id="formId" action="update.php?id=<?php echo $row["id"];?>" method="post" onsubmit="return mySubmit();">
            <table id="myTable">
              <tr>
                <td>Enter UserName</td>
                <td><input type="text" name="username" id="uname" value="<?php echo $row["name"]?>"></td>
              </tr>
              <tr>
                <td>Enter Email</td>
              ...
              <tr>
                <td>Enter Id</td>
                <td><input type="text" name="Id" id="Id" value="<?php echo $row["std_id"]?>"></td>
              </tr>
              <tr>
                <td>About Yourself</td>
                <td><textarea name="about" id="about"><?php echo $row["about"]?></textarea></td>
              </tr>
              <tr>
